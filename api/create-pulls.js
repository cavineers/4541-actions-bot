...
class PullRequests {
    static createNewPullRequest(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { data: { html_url, number }, } = yield this.GitHub.octokit.request(`POST /repos/{owner}/{repo}/pulls`, Object.assign(Object.assign({}, GitHub_1.GitHubRepository.getRepo()), { title: data.title, body: data.body, head: data.branch, base: DEFAULT_BRANCH }));
